  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <form action="add_billing.php" method="POST">
        ...
        $present_reading = $con_row['present_reading'];
      ?>
        ...
        <script>
            console.log(<?php echo $present_reading ?>);
            </script>
      <?php
...
<script>
    ...
    function myFunction()
    {
        ...
        let kwh_used = pres_reading - prev_reading;
        document.getElementById("kwh_used").value = kwh_used;
        alert(pres_reading);
