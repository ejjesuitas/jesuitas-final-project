...
<ul>
  ...
  <li><a href="billing_table.php">Billing Table</a></li>
...
<div style="margin-left:9%;padding:1px 16px;height:1000px;">
    <div class="container">
        ...
        <table class = "styled-table">
            ...
            <?php
            $result = mysqli_query($conn, "SELECT * FROM consumer ORDER BY last_name ASC");
            ...
            <td>
                <a href="#account_number=<?php echo $row['account_number']?>&id=<?php echo $row['id']?>"  data-bs-toggle="modal">
